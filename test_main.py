...
class TestBookRepository:
    def test_create_book(self, test_db):
        ...
        assert book.publisher == TEST_BOOKS[0]["publisher"]  # Test publisher
    ...
    def test_update_book(self, test_db):
        ...
        assert updated_book.publisher == TEST_BOOKS[1]["publisher"]  # Test publisher

    def test_delete_book(self, test_db):
        """Test deleting a book"""
        book = create_book(test_db, BookIn(title="To Delete", author="Author", publisher="Publisher"))
    ...
    def test_nonexistent_operations(self, test_db):
        ...
        assert update_book(test_db, 999999, BookIn(title="Test", author="Test", publisher="Test")) is None
